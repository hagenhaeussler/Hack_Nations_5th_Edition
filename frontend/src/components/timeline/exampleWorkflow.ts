...
/**
 * Exemplary DAG describing the workflow for preparing a basic biology
 * experiment. The graph is laid out left-to-right with three parallel
 * preparatory branches (reagents / protocol / controls) converging into the
 * pilot run before the main experiment proceeds.
 *
 * Coordinates are in graph units; @xyflow/react handles pan/zoom around them.
 */
...
export const EXAMPLE_NODES: Node<WorkflowNodeData>[] = [
  {
    id: "hypothesis",
    type: "workflow",
    ...
    data: {
      ...
      schedule: "Day 0",
      detail: "State the question, the model system, and the predicted effect.",
      status: "done",
      icon: "lightbulb",
      effort: "Half a day",
      description:
  ...
  // Three parallel preparatory branches
  {
    id: "reagents",
    type: "workflow",
    ...
    data: {
      ...
      schedule: "Week 2–3",
      detail: "Antibodies, primers, media, plasticware. Confirm lead times.",
      status: "upcoming",
      icon: "package",
...
export const EXAMPLE_EDGES: Edge[] = [
  ...
  // Fan-out into the three preparatory branches
