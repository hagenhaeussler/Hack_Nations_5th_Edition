...
export function fallbackExtractHypothesis(hypothesis: string): HypothesisExtraction {
  ...
  return {
    ...
    scientific_ontology: {
      intervention: "Primary condition or intervention from the hypothesis",
      control: "Control condition to be confirmed",
      biological_system: null,
      endpoint: "Measured outcome defined during planning",
      mechanism: null,
  ...
  return [
    {
      ...
      metadata: {
        domain,
        fallback_reason: "research_api_missing",
        provider: "labpilot_demo",
        source_kind: "fallback_protocol_context",
        intended_corpora: ["literature", "protocols", "supplier_docs", "standards"],
      },
    ...
    },
    {
      ...
      metadata: {
        ...
        fallback_reason: "research_api_missing",
        provider: "labpilot_demo",
        source_kind: "fallback_validation_context",
        intended_corpora: ["literature", "protocols", "supplier_docs", "standards"],
      },
